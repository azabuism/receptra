...
# 【一時】Outbound AI Phase 1 Production E2E検証用。検証完了後、本import・
# 下のinclude_router呼び出し・app/routers/_outbound_e2e_debug.py 自体を
...
def create_app() -> FastAPI:
    ...
    app.include_router(e2e_debug_router)  # 【一時】Production E2E検証用。検証後に削除
