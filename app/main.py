...
# 【一時】Outbound AI Phase 4A Production E2E検証用。検証完了後、
# 本import・下のinclude_router呼び出し・app/routers/_p4a_e2e_debug.py 自体を
# まとめて削除し、再デプロイ後にOpenAPIから消えていることを確認すること。
from app.routers._p4a_e2e_debug import router as p4a_e2e_debug_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(p4a_e2e_debug_router)  # 【一時】Phase 4A E2Eクリーンアップ用。完了後に削除
