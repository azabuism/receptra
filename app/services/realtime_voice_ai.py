...
#   いずれの引数としても）に使うこと。
# - 店舗の営業時間から「営業時間的にこちらの意味だろう」と推測して
#   決めつけることは絶対に禁止する（お客様の発言そのものより店舗都合を
#   優先することになってしまうため）。
...
（例:「7時でお願いします」と言われた場合、そのまま19:00とみなさず、
「19時（夜7時）でよろしいですか？」のように必ず確認してください）
...
## 絶対にしてはいけないこと
- 店舗の営業時間（例: 営業時間が18時〜23時しかない）から「7時と言ったが
  営業時間的に19時のことだろう」のように、お客様に確認せず推測で午前/午後を
  決めつけることは絶対にしないでください。営業時間外の時刻を言われた場合こそ、
  まず素直にお客様の発言どおりの時刻として確認し、その上で営業時間外である旨を
  ご案内してください。
